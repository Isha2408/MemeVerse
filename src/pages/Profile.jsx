  ...
  return (
    <div className="p-6 max-w-3xl mx-auto text-center">
      ...
      {activeTab === "uploads" && (
        <MemeGrid
          memes={userMemes}
          message="You haven't uploaded any memes yet!"
        />
      )}
      {activeTab === "liked" && (
        <MemeGrid
          memes={likedMemes}
          message="You haven't liked any memes yet!"
        />
      )}
      {activeTab === "edit" && (
...
function EditProfile({ profile, setProfile }) {
  ...
  return (
    <motion.div
      className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg shadow-md mt-6"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    >
